...
class _chatbotScreenState extends State<chatbotScreen> {
  ...
  final Map<String, ChatResponse> questionResponses = {
    ...
    'sahrdaya entrance': ChatResponse(
      response:
          'At the entrance path of sahrdaya there are three stands where three holy Books are kept',
      imagePath: 'assets/image/sahrdaya.jpg',
    ),
    'jasmine hall': ChatResponse(
      response:
          'Please go to the right side of the ground floor in the main block',
    ...
    'administration office': ChatResponse(
      response:
          'you can find the administration office in the left side of the ground floor',
      imagePath: 'assets/image/Administration.jpg',
    ),
    'academic office': ChatResponse(
      response:
          'You can find the Academic Office on the right side of the ground floor.',
      imagePath: 'assets/images/academicoffice.jpg',
    ),
    'first year staff room': ChatResponse(
      response:
          'Please go to the first floor of the main block and then take a right to find the First Year Staff Room.',
      imagePath: 'assets/images/firstyearstaffroom.jpg',
    ),
    'vice principal\'s office': ChatResponse(
      response:
          'Please go to the first floor of the main block and take a left to find the Vice Principal\'s Office.',
      imagePath: 'assets/images/viceprincipalsoffice.jpg',
    ),
    'physics lab': ChatResponse(
      response:
          'Please go to the second floor of the main block and take left where you will see the physics lab',
      imagePath: 'assets/image/physics.jpg',
    ),
    'chemistry lab': ChatResponse(
      response:
          'Please go to the second floor of the main block and take right where you will see the chemistry lab',
    ...
    'accenture lab': ChatResponse(
      response:
          'Accenture Lab is located on the right side of the ground floor in the Bio Block.',
    ),
    'ce dept': ChatResponse(
      response:
          'The CE Department is located on the right side of the first floor in the Decineal Block.',
    ),
    'eee': ChatResponse(
      response:
          'The EEE Department is located on the left side of the first floor in the Decineal Block.',
    ),
    'cs dept': ChatResponse(
      response:
          'The CS Department is located on the second floor in the Decineal Block.',
    ),
    'cs hod': ChatResponse(
      response:
          'The HOD\'s room for CS Department is located on the second floor in the Decineal Block.',
    ),
    'lift': ChatResponse(
    ...
    'thank you': ChatResponse(
      response:
          "it's my pleasure to help you,just text me if you need any more help.",
    ),
  ...
  void initState() {
    ...
    chatMessages.add(ChatMessage(
      message:
          "Chatbot: Welcome to Sahrdaya!  I'm PLUTO ,your virtual assistant you can ask questions i will try to sort out them",
      isUserMessage: false,
    ));
  }
                ...
                return ListTile(
                  ...
                  leading: chatMessage.isUserMessage
                      ...
                      : chatMessage.imagePath != null
                          ? GestureDetector(
                              onTap: () => viewImage(chatMessage.imagePath!),
                              child: Image.asset(
